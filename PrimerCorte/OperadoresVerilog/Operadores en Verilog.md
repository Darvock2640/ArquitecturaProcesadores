...
En Verilog se usa el signo ***(=)*** para denotar asignación, de esta forma, el lado izquierdo de la expresión **(LHS  Left-Hand Side)** será el objetivo de la asignación, mientras el lado derecho **(RHS Right-Hand Side)** contiene los ***signals***, ***constants***, ***operators*** que serán asignados. Ejemplo:
...
Se pueden realizar varias asignaciones continuas al mismo ***net***, en este caso, el ***net*** tomará el valor de la fuente que tenga el nivel de ***strenght*** más alto. 
...
assign F3 = 4’hA; 	// F3 es un vector de 8 bits que continuamente está siendo asignado con 0000_1010
```
...
![BitwiseOperator](images/BitwiseOperators.png)
...
![Reduction](images/ReductionOperators.png)
...
El operador de relación retorna un valor de verdadero o falso basado en la comparación de cantidades de dos entradas.
...
En Verilog las llaves ***( { } )*** son usadas para concatenar multiples señales, el objetivo de esta operación debe ser del mismo tamaño que la suma de los argumentos de entrada, ejemplo:
...
```
## Operadores de replicación
Verilog posee un operador que permite concatenar un vector con si mismo que se denomina *” operador de replicación”*, este operador usa doble llave ***( {{ }} )*** y un número entero que determina las veces que se va a replicar el vector. Su sintaxis es:
```verilog
...
X + Y 			// suma X con Y
X - Y 			// Resta Y de X
-X 			    // Aplica el complemento a 2 a X 
...
Diseñar un circuito combinacional cuyo comportamiento se especifica a través de la siguiente tabla de verdad.

![TablaX](images/TablaX.png)

* Diagrama en bloques

    ![BloquesX](images/EsquemaX.png)

* Función lógica

    ![Ecuación](images/EcuacionX.png)
